...
const queueManager = 'Conn'; // Queue Manager name
const queueName = 'OUT.QUEUE'; // IBM MQ queue name
const channel = 'MY.SVRCONN'; // IBM MQ channel name
const host = 'localhost'; // IBM MQ host
const port = '1417'; // IBM MQ port
const mqUser = 'mqadmin'; // standared system user
const mqPassword = 'Password123'; // Password of user 
